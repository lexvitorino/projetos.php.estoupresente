...
class Create extends Conn {
    ...
    public function ExeCreate($Tabela, array $Dados) {
        ...
        if (!empty($_SESSION['userlogin'])) {
            $this->Dados['id_subscriber'] =  (int) $_SESSION['userlogin']['id_subscriber'];
            $this->Dados['created_id_user'] = (int) $_SESSION['userlogin']['id'];
        }

        $this->Dados['created_date'] = date('Y-m-d H:i:s');
